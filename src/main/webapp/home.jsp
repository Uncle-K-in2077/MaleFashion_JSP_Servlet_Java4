...
<body>
	...
	<c:if test="${notify != null }">
		<div style="margin: auto 180px" class="alert alert-danger d-flex align-items-center" role="alert">
	...
	<%@include file="include/CountdownTemplate.jsp"%>
